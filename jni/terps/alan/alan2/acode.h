...
/* Original source below assumes that sizeof(long) will be 32 bits (4 bytes),
 * but this may not be true on some hardware. Use stdint library to improve
 * portability - TCC Dec 2017 */
#include <stdint.h>
